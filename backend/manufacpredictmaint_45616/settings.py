"""
Django settings for manufacpredictmaint_45616 project.
...
ROOT_URLCONF = 'manufacpredictmaint_45616.urls'
...
WSGI_APPLICATION = 'manufacpredictmaint_45616.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manufacpredictmaint_45616 API",
    "DESCRIPTION": "API documentation for manufacpredictmaint_45616 App",
    "VERSION": "v1",
}
